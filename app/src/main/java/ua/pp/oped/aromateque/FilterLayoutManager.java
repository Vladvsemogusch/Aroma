...
public class FilterLayoutManager extends RecyclerView.LayoutManager {
    ...
    /*
        ...
        private void fillDown(RecyclerView.Recycler recycler) {
            ...
            int viewHeight = (int) (getHeight() * 0.5f);
            int widthSpec;
            int heightSpec;
            ...
            while (fillDown && pos < itemCount){
                ...
                addView(view);
                widthSpec = View.MeasureSpec.makeMeasureSpec(getWidth(), View.MeasureSpec.UNSPECIFIED);
                heightSpec = View.MeasureSpec.makeMeasureSpec(getHeight(), View.MeasureSpec.UNSPECIFIED);
                Log.d("FILTER_LAYOUT_MANAGER",String.valueOf(getDecoratedMeasuredWidth(view)));
                Log.d("FILTER_LAYOUT_MANAGER",String.valueOf(getDecoratedMeasuredHeight(view)));
    ...
    public void smoothScrollToPosition(RecyclerView recyclerView, RecyclerView.State state, int position) {
        ...
        LinearSmoothScroller scroller = new LinearSmoothScroller(recyclerView.getContext()) {
            ...
            public PointF computeScrollVectorForPosition(int targetPosition) {
                return FilterLayoutManager.this.computeScrollVectorForPosition(targetPosition);
            }
