 ...
 */
public class AdvancedListenerRangeSeekBar<T extends Number> extends ImageView {
    /**
     * Default color of a {@link AdvancedListenerRangeSeekBar}, #FF33B5E5. This is also known as "Ice Cream Sandwich" blue.
     */
    ...
    public AdvancedListenerRangeSeekBar(Context context) {
        super(context);
        init(context, null);
    }

    public AdvancedListenerRangeSeekBar(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public AdvancedListenerRangeSeekBar(Context context, AttributeSet attrs, int defStyle) {
    ...
    public interface OnRangeSeekBarChangeListener<T> {
        ...
        void onRangeSeekBarValuesChanged(AdvancedListenerRangeSeekBar<?> bar, T minValue, T maxValue, boolean isDragging);
    }
